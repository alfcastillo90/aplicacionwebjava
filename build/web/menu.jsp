...
<head>
    ...
    <meta name="description" content="Panel administrativo con un backend hecho en java">
    <meta name="keywords" content="java, materialize, html, css, panel admin">
    <title>Java Restaurants</title>
        ...
        <div class="navbar-fixed">
            <nav class="cyan">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="menu.jsp" class="brand-logo darken-1"><span class="logo-text">Materialize</span></h1></h1>
